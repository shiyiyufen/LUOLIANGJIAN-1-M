...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view text:(NSString *)text showImmediately:(BOOL)show
{
...
+ (BOOL)isFinishedForView:(UIView *)view
{
...
- (void)setupLabels {
	...
	label.textColor = self.color ? [UIColor grayColor]: [UIColor whiteColor];
	...
	detailsLabel.textColor =  self.color ? [UIColor grayColor]: [UIColor whiteColor];
...
- (void)updateIndicators {
	...
	if (mode == MBProgressHUDModeIndeterminate &&  !isActivityIndicator) {
		...
		self.indicator = MB_AUTORELEASE([[UIActivityIndicatorView alloc]
										 initWithActivityIndicatorStyle: self.color ? UIActivityIndicatorViewStyleGray: UIActivityIndicatorViewStyleWhiteLarge]);
...
- (void)layoutSubviews {
	...
	CGRect labelF;
	labelF.origin.y = indicatorF.size.width ? yPos  + 10 : yPos;
	...
	detailsLabelF.origin.y = labelSize.width ? yPos  + 10 : yPos;
